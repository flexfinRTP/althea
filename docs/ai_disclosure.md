...
```text
AI assisted in generating initial smart-contract unit-test cases.

Human contributors executed the tests, reviewed expected behavior,
added failure cases, and confirmed the deployed contract behavior.
```
...
* [ ] document ChatGPT use;
* [ ] document coding assistant;
* [ ] identify AI-assisted smart contract;
* [ ] identify AI-assisted backend;
* [ ] identify AI-assisted frontend;
* [ ] identify AI-assisted tests;
* [ ] identify AI-generated assets;
* [ ] identify AI-assisted copy;
* [ ] preserve specs;
* [ ] preserve prompts;
* [ ] disclose starter kits;
* [ ] disclose reused libraries;
* [ ] ensure meaningful human contribution is clear;
